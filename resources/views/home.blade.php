@extends('layouts.app')
@section('title', __('Tablero de control general'))
@section('content')
...
<div class="row justify-content-center">
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				<h5><strong>{{ Auth::user()->name }},</strong> {{ __('El avance de las actividades en general es el siguiente:') }}{{ config('app.name', 'Laravel') }}</h5>
				</br> 
				<hr>
			...
			<div class="row w-100" >
					<div class="col-md-4">
						<div class="card border-success mx-sm-1 p-3">
							...
							<div class="text-success text-center mt-2"><h1>{{$cumplidas}}</h1></div>
					...
					<div class="col-md-4">
						<div class="card border-warning mx-sm-1 p-3">
							...
							<div class="text-warning text-center mt-2"><h1>{{ $en_proceso}}</h1></div>
					...
					<div class="col-md-4">
						<div class="card border-danger mx-sm-1 p-3">
							...
							<div class="text-danger text-center mt-2"><h1>{{$pendientes }}</h1></div>
