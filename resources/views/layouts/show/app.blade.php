                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <button type="button" class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu">
									<a href="{{ url('/evento/show/1') }}" class="dropdown-item "> <i class="fa fa-calendar text-semujer"></i> General</a>
									<a  href="{{ url('/evento/2') }}" class="dropdown-item " ><i class="fa fa-calendar text-semujer"></i> Secretaría Técnica </a>
									<a href="{{ url('/evento/3') }}" class="dropdown-item "><i class="fa fa-Calendar text-semujer"></i> Coordinación Administrativa</a>											 
                                    <a href="{{ url('/evento') }}" class="dropdown-item"> <i class="fa fa-calendar text-semujer"></i> Unidad de Planeación</a>
									<a href="#" class="dropdown-item" ><i class="fa fa-calendar text-semujer"></i> Subs Derecho Mujeres</a>
									<a href="#" class="dropdown-item"><i class="fa fa-Calendar text-semujer"></i> Dirección de At Mujeres Victimas Volemcia </a>
                                    <a href="{{ url('/evento') }}" class="dropdown-item "> <i class="fa fa-calendar text-semujer"></i>Direccion de empoderamiento económico</a>
									<a href="#" class="dropdown-item" ><i class="fa fa-calendar text-semujer"></i>Subsecretaria para la igualdad sustantiva</a>
									<a href="#" class="dropdown-item"><i class="fa fa-Calendar text-semujer"></i> Dirección de Transversalización </a>
                                    <a href="{{ url('/evento') }}" class="dropdown-item"> <i class="fa fa-calendar text-semujer"></i> Dirección de Institucionalización</a>
									<a href="#" class="dropdown-item" ><i class="fa fa-calendar text-semujer"></i>Dirección Jurídica</a>
									<a href="#" class="dropdown-item"><i class="fa fa-Calendar text-semujer"></i> Dirección de capacitación e Investigación</a>
                                    <a href="{{ url('/evento') }}" class="dropdown-item"> <i class="fa fa-calendar text-semujer"></i> BANEVIM</a>
                                </ul>
